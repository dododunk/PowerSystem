...
BEGIN_MESSAGE_MAP(CProgressDlg, CDialog)
	...
	ON_WM_CTLCOLOR()
	ON_WM_NCLBUTTONDOWN()
	ON_NOTIFY(NM_OUTOFMEMORY, CG_IDC_PROGDLG_PROGRESS, OnOutofmemoryIdcProgdlgProgress)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CProgressDlg::OnPaint() 
{
	...
	CBrush brush(RGB(160,180,220));//RGB(128,128,128));RGB(224,223,227)
	CRect          rt;
	GetClientRect(rt);
...
void CProgressDlg::OnOutofmemoryIdcProgdlgProgress(NMHDR* pNMHDR, LRESULT* pResult) 
{
