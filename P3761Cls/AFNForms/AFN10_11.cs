	...
	public class AFN10_11 : iForm
	{
		...
		protected override void GetText()
		{
			...
			checked
			{
				...
				text += (this.checkBox1.Checked ? "FF" : "00");
		...
		public override void SetText()
		{
			checked
			{
				if (!string.IsNullOrEmpty(this.Data))
				{
					...
					num += 12;
					this.checkBox1.Checked = (data.Substring(num, 2) == "FF");
					num += 2;
					num += 2;
		...
		private void InitializeComponent()
		{
			...
			this.textBox1.Location = new Point(104, 12);
			...
			base.ClientSize = new Size(367, 296);
