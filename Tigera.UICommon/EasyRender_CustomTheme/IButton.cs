...
namespace EasyRender_CustomTheme
{
	public class IButton : IDisposable
	{
		...
		private Color _hoverBackTop = Color.FromArgb(215, 223, 231);
		private Color _hoverBackBottom = Color.FromArgb(193, 210, 238);
		private Color _clickBackTop = Color.FromArgb(193, 210, 238);
		private Color _clickBackBottom = Color.FromArgb(215, 223, 231);
