...
namespace EasyRender_VS2010Theme
{
	...
	{
		private Color _menuBorderDark = Color.FromArgb(192, 202, 202);
		...
		private Color _menuStripBtnBorder = Color.FromArgb(192, 202, 202);
		private IButton _buttons = null;
		private Color _marginLeft = Color.FromArgb(192, 202, 202);
