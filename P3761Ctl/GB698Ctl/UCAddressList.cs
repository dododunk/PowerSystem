...
{
    //地址列表。
    public class UCAddressList : UserControl
    {
        ...
        private void cbHeader_OnCheckBoxClicked(bool state)
        {
            ...
            {
                base.Invoke(new UCAddressList.cbHeader_OnCheckBoxClickedDelegate(this.cbHeader_OnCheckBoxClicked), new object[]
				{
					state
				});
            }
        ...
        private void CheckALL(bool CK)
        {
            ...
            checked
            {
                if (base.InvokeRequired)
                {
                    base.Invoke(new UCAddressList.CheckALLDelegate(this.CheckALL), new object[]
					{
						CK
					});
                }
        ...
        private void AddClient(string obj)
        {
            ...
            checked
            {
                if (base.InvokeRequired)
                {
                    base.Invoke(new UCAddressList.AddClientDelegate(this.AddClient), new object[]
					{
						obj
					});
                }
        ...
        private void InitializeComponent()
        {
            ...
            base.Name = "AddressListUserControl";
