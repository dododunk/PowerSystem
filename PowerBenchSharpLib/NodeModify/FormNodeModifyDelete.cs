...
namespace PowerBenchSharpLib
{
    public partial class FormNodeModifyDelete : Form
    {
        ...
        private void button_OK_Click(object sender, EventArgs e)
        {
            ...
            if (this.editField1.Changed || this._ope == DataOpeMode.Del)
            {
                ...
                {                    
                    ...
                    if (L1stationnode != null)
                    {
                        ...
                        sql = string.Format("update AMMETERINFO set USER_STATIONNAME = '{0}' where user_company= '{1}' and USER_STATIONNAME = '{2}'",
                            this.editField1.Result,
                    ...
                    {
                        var cur = L2busnode;
                        sql = string.Format("update AMMETERINFO set USER_BUS = '{0}' where user_company= '{1}' and USER_STATIONNAME = '{2}' and USER_BUS = '{3}'",
                            this.editField1.Result,
                    ...
                    {
                        var cur = L3linenode;
                        sql = string.Format("update AMMETERINFO set USER_LINENAME = '{0}' where user_company= '{1}' and USER_STATIONNAME = '{2}' and USER_BUS='{3}' and USER_LINENAME='{4}'",
                            this.editField1.Result,
                    ...
                    {
                        var cur = L4transinfo;
                        sql = string.Format("update AMMETERINFO set USER_TRANSFORMER = '{0}' where user_company= '{1}' and USER_STATIONNAME = '{2}' and USER_BUS='{3}' and USER_LINENAME = '{4}' and USER_TRANSFORMER = '{5}' ",
                            this.editField1.Result,
                    ...
                    if (L5moduleinfo != null)
                    {
                        ...
                        sql = string.Format("update AMMETERINFO set USER_MODULE = '{0}' where user_company= '{1}' and USER_STATIONNAME = '{2}' and USER_BUS='{3}' and USER_LINENAME = '{4}' and USER_TRANSFORMER = '{5}'and USER_MODULE = '{6}' ",
                            this.editField1.Result,
                            cur.Company, cur.Station, cur.Bus, cur.Line, cur.Tranformer, cur.Module);
                    }
